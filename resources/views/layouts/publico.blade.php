        ...
        <div class="header-top">
            <div class="container">
                ...
                <div class="header-actions pull-right">
                    <a href="#" ><img src="images/upload/banners/mapasbanner.jpg"  ></a>
                </div>  
    ...
    <li class="menuparent">
        ...
        <ul class="sub-menu">
            ...
            <li><a href="blog-fullwidth.html">Fullwidth</a></li>
                    ...
                    <div class="form-search-wrapper col-sm-12">
                        <form method="post" action="?" class="form-horizontal form-search">
                            ...
                            <div >
                               ...
                               <?php  echo Form::label('Hotel', 'Hoteles', ['class' => 'cate-1','id' => 'icon-1' ]); ?>
                               <?php  echo Form::checkbox('Hotel', 'value', true, ['class' => 'cate-1','id' => 'icon-1']); ?>
                               <?php  echo Form::label('Restaurante', 'Restaurantes', ['class' => 'cate-2','id' => 'icon-2']); ?>
                               <?php  echo Form::checkbox('Restaurante', 'value', true, ['class' => 'cate-2','id' => 'icon-2']); ?>
                               <?php  echo Form::label('Tours', 'Tours',['class' => 'cate-3','id' => 'icon-3']); ?>
                               <?php  echo Form::checkbox('Tours', 'value', true, ['class' => 'cate-3','id' => 'icon-3']); ?>
                            </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript" src="http://www.snyderplace.com/demos/javascript/jquery.collapsible.js"></script>
